...
import static cn.huava.cloud.common.constant.CommonConstant.ENV_PROD;
import static cn.huava.cloud.common.constant.CommonConstant.ENV_PRODUCTION;
...
public class RedisUtil {
  ...
  public static double getHitRatioPercentage() {
    RedisConnection connection =
        Objects.requireNonNull(SpringUtil.getBean(StringRedisTemplate.class).getConnectionFactory())
            .getConnection();
  ...
  public static long randomOffsetDurationInSeconds() {
    String minutesStr =
        SpringUtil.getBean(Environment.class).getProperty("spring.cache.redis.time-to-live");
  ...
  /**
   * Put a value into a Redis List.
   *
   * @param listName List name (key)
   * @param value Value
   */
  public static void putListValue(@NonNull String listName, Object value) {
