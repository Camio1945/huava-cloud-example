...
public class NacosConfigService implements ConfigService {
  ...
  @Deprecated ServerHttpAgent agent = null;

  private String namespace;

  public NacosConfigService(Properties properties) throws NacosException {
    System.out.println();
    properties.forEach((k, v) -> System.out.println("init property, key : " + k + ", value : " + v));
    System.out.println();
  ...
  public String getConfigAndSignListener(
      String dataId, String group, long timeoutMs, Listener listener) throws NacosException {
    ...
    worker.addTenantListenersWithContent(
        dataId, group, content, encryptedDataKey, Collections.singletonList(listener));
  ...
  @Override
  public boolean publishConfigCas(
  ...
  private String getConfigInner(String tenant, String dataId, String group, long timeoutMs)
    ...
    if (content != null) {
      LOGGER.warn(
          "[{}] [get-config] get failover ok, dataId={}, group={}, tenant={}, config={}",
          worker.getAgentName(),
          dataId,
          group,
          tenant,
      ...
      String encryptedDataKey =
          LocalEncryptedDataKeyProcessor.getEncryptDataKeyFailover(
    ...
    cr.setContent(content);
    String encryptedDataKey =
        LocalEncryptedDataKeyProcessor.getEncryptDataKeySnapshot(
            agent.getName(), dataId, group, tenant);
    cr.setEncryptedDataKey(encryptedDataKey);
    configFilterChainManager.doFilter(null, cr);
    content = cr.getContent();
